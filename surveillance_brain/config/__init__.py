...
EVENT_RETENTION_DAYS: Final[int] = _settings.EVENT_RETENTION_DAYS
MEDIA_RETENTION_DAYS: Final[int] = _settings.MEDIA_RETENTION_DAYS

OCCUPANCY_ENTRY_CAMERAS: Final[str] = _settings.OCCUPANCY_ENTRY_CAMERAS
OCCUPANCY_EXIT_CAMERAS: Final[str] = _settings.OCCUPANCY_EXIT_CAMERAS
OCCUPANCY_INSIDE_MINUTES: Final[int] = _settings.OCCUPANCY_INSIDE_MINUTES
